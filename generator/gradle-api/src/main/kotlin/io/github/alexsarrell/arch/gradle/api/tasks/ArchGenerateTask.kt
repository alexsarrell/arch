package io.github.alexsarrell.arch.gradle.api.tasks
...
import io.github.alexsarrell.arch.gradle.api.util.build
...
abstract class ArchGenerateTask : DefaultTask() {
    ...
    @get:Input
    @get:Optional
    abstract val modelDocsFormat: Property<String>
    ...
    @TaskAction
    fun generate() {
        pipelineStarter.get().runPipeline(TaskContext.build(this))
    }
}
